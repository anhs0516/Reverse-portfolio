...
우선 암호화 공식을 보자마자 당황했다. 처음에 공식을 봤어도 RSA를 몰라서 그랬고 이를 직접 해석해서 풀려고 했으나 도저히 풀리지 않았다.

RSA를 몰라도 역으로 혼자 풀 수 있는 정도가 안된다.... 아직 많이 부족하고 더 많은 암호화 문제를 풀어봐야겠다.

나중가면 딱 보면 어떤 암호화로 구성되었는지 알 수 있을까? 아니면 공식인지 몰라도 혼자 역으로 풀 수 있을 정도의 실력자가 되려면 어떻게 해야할까라는 고민이 많이 든 문제였다.
