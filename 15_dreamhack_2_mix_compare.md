...
1. 입력값이 존재하는데 몇자리를 입력해야 하는지 찾기
2. 조건문들이 실행된 후의 값들을 리스트로 뽑기
3. 1~64자리까지의 조건들을 역연산할 수 있게 코딩하기
4. 뽑은 리스트와 조건 역연산을 이용하면 최종 flag 값 획득


# 느낀점

코딩을 좀 더 많이 해봐야한다. 속도도 느리고 생각이 느리다. 
데이터 뽑는데 한번 잘못 입력하니 시간이 배로 소모되었다.
